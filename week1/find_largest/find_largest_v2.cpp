...
// this is after some tidying (extract methods)
...
int main() {
    ...
    try {
        // read three values
        double first_value = read_double();
        double second_value = read_double();
        double third_value = read_double();

        // find the max of the values
        double max = max3(first_value, second_value, third_value);
